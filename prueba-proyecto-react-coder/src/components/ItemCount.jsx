    ...
    return (
        <div className="container">
            ...
            <div className="row">
                <div className="col">
                    {
                        itemStock > 0 ? <button type="button" className="btn btn-secondary w-100" onClick={onAdd} >Añadir al carrito</button> : <button type="button" className="btn btn-secondary w-100 disabled" onClick={onAdd} >Añadir al carrito</button>
                    }
                </div>
            </div>
        </div>
